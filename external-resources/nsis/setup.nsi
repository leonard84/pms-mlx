...
Section "Program Files"
  SetOutPath "$INSTDIR"
  SetOverwrite on
  File /r /x "*.conf" /x "*.zip" /x "*.dll" /x "third-party" "${PROJECT_BASEDIR}\..\external-resources\plugins"
  File /r "${PROJECT_BASEDIR}\..\external-resources\documentation"
  File /r "${PROJECT_BASEDIR}\..\external-resources\renderers"
  File /r "${PROJECT_BINARIES}\win32"
  File "${PROJECT_BUILD_DIR}\PMS.exe"
  File "${PROJECT_BASEDIR}\..\external-resources\PMS.bat"
  ...
  File "${PROJECT_BASEDIR}\..\external-resources\logback.xml"
  File "${PROJECT_BASEDIR}\..\external-resources\icon.ico"

  ;the user may have set the installation dir
  ;as the profile dir, so we can't clobber this
  SetOverwrite off
  File "${PROJECT_BASEDIR}\..\external-resources\WEB.conf"
